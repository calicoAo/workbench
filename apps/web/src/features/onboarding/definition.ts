...
export const coreLoopFlow: TutorialFlow = {
  ...
  steps: [
    ...
    { id: "start", kind: "spotlight", route: "/today", target: "task.start", title: "开始一次行动", body: "准备好了再开始。开始以后，Workbench 才会记录这次真正投入的时间。", placement: "top", advance: "condition", interaction: "target-only", skippable: true, missingTargetPolicy: "wait" }
  ]
};
